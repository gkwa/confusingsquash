...
import (
	...
	"github.com/gkwa/confusingsquash/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.confusingsquash.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".confusingsquash")
	}
